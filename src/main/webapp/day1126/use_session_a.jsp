...
<strong>세션 사용</strong>
	<form name="frm" id="frm" action="use_session_b.jsp">
		<!-- action을 주지 않으면 내 페이지로 간다. -->
		<label>이름</label> <input type="text" name="name" id="name"><input type="text" style="display: none"> <input
			type="button" value="입력" id="btn" class="btn btn-info">
	</form>
</body>
</html>