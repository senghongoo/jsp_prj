				...
				<div class="col-md-7">
					...
					<div class="card" style="width: 18rem;">
						...
						<div class="card-body" style="float: right;">
							<h5 class="card-title"><c:out value="${ pDTO.title }"></c:out></h5>
							<p class="card-text"><c:out value="${ pDTO.info }"></c:out>
							<br>
							제조일 : <fmt:formatDate value="${ pDTO.prdDate }" pattern="yyyy-mm-dd HH:mm"/>
							</p>
							<a href="#" class="btn btn-primary"><fmt:formatNumber value="${ pDTO.price }" pattern="#,###"></fmt:formatNumber>원</a>
						</div>
					</div>
					</c:forEach>
				</div>
