  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					<a href="<%=iDTO.getUrl()%>" target="blank"><img
						src="http://192.168.10.88/jsp_prj/common/images/<%=iDTO.getImg()%>"></a>
				</div>
			</div>
			<%
			} // end for
			...
			<div class="row featurette">
				<div class="col-md-7">
				<img src="http://192.168.10.88/jsp_prj/common/images/james.png"><br>
				데이터를 먼저 넣어보세요~
				</div>
			</div>
			<%
