...
<body>
		...
		<table>
			<tr>
				...
				<td rowspan="2"><input type="button" value="입력" id="btn"
					class="btn btn-info" style="height: 80px;" tabindex="3"></td>
			</tr>
			<tr>
	...
	%>
	쿠키명 :
	<%=cookieName.get(i)%><br> 쿠키값 :
	<%=cookieValue.get(i)%><br>
	<%
	} // end for
	%>
