					...
					<form name="modifyFrm" method="post" id="modifyFrm"
						...
						<table id="joinFrm">
							<tr>
								...
								<td class="input"><strong><c:out
											value="${ sessionScope.userId }"></c:out></strong></td>
							</tr>
							<tr>
								<td class="input" colspan="2"><img
									src="${ CommonURL }/upload/${ pDTO.profile }" id="preview"
									...
									value="업로드" class="btn btn-success bnt-sm" id="btnUpload" /><br>
							...
							<tr>
								...
								<td class="input"><strong><c:out
											value="${ pDTO.name }"></c:out></strong></td>
							</tr>
							<tr>
								<td class="title"><label><span class="star">*</span>이메일</label></td>
								<td class="input"><input type="text" name="mail"
									class="inputBox" value="${ email }" />@ <select name="domain"
									id="domain">
							...
							<tr>
								...
								<td class="input"><select name="loc" id="loc"
									class="inputBox" style="width: 120px; height: 25px">
							...
							<tr>
								...
								<td><textarea name="intro"
										...
										<c:out value="${ pDTO.intro }"></c:out>
										</textarea></td>
							</tr>
							<tr>
								<td colspan="2" style="text-align: center"><input
									type="hidden" name="code" value="U3881"> <input
									type="button" value="변경" class="btn btn-success" id="btn" /></td>
							</tr>
						</table>
					</form>
				</div>
