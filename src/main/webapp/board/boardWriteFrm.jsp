...
<c:if test="${ sessionScope.userId }">
	<c:redirect url="${ CommonURL }/login/loginFrm.jsp"></c:redirect>
</c:if>
<script type="text/javascript">
  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					<h2>글쓰기</h2>
					<form action="boardWriteFrmProcess.jsp" method="post" name="frm"
						id="frm">
						<table>
							<tr>
							...
							<tr>
								<td>ID/IP</td>
								<td><c:out value="${ sessionScope.userId }"></c:out>/<%=request.getRemoteAddr()%></td>
							</tr>
							<tr>
								<td colspan="2" style="text-align: center;">
									<button onclick="return false" class="btn btn-success"
										id="btnWrite">글쓰기</button> <a
									href="boardList.jsp?currentPage=${ param.currentPage }"
