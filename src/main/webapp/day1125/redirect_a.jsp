...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" info="정상적인 응답페이지 - 비정상적인 요청이 발생할 수 있다."%>
<!DOCTYPE html>
<html lang="en" data-bs-theme="auto">
<head>
<%
session.setAttribute("name", "안세홍");
if (new Random().nextBoolean()) { // 로그인이 안 된 경우 ( 세션이 존재하지 않는 경우 )
	// 비정상적인 요청이 발생한 경우
%>
...
// return; // 문제가 발생했을 때 아랫줄을 실행하지 못하도록 막는다.
} // end if
%>
<meta charset="UTF-8">
  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					정상적인 응답<br> <img src="images/redirect.png" title="M 탈모 리다이렉트">
				</div>
			</div>
			<hr class="featurette-divider">
			<!-- /END THE FEATURETTES -->
