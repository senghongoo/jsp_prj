...
<%
// 악의적인 목적의 사용자
String[] blockIp = {"192.168.10.76", "192.168.10.78", "192.168.10.96", "192.168.10.85", "192.168.10.83",
		"192.168.10.73", "192.168.10.90", "192.168.10.91"};
  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">정상적인 사용자</div>
			</div>
			<hr class="featurette-divider">
			<!-- /END THE FEATURETTES -->
		</div>
