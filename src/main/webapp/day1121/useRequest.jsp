...
<body>
 ...
 %>
			...
			%>
			이름 :<%=headerName%>, 값 :<%=request.getHeaderNames()%><br>
			<%
			} // end while
			%>
			</li>
	...
	<div>
		<a href="useRequest.jsp?nick=ahn&age=20&age=30">요청</a><br>

		<!-- form 태그에 action 속성을 사용하지 않으면 기본적으로 자기 페이지를 요청한다. -->
		<form method="get" action="useRequest.jsp" enctype="multipart/form-data">
			<input type="hidden" name="nick" value="lee"> <input
				type="hidden" name="age" value="21"> <input type="hidden"
				name="age" value="25">
			<button>요청</button>
		</form>
